...
add_turtle_pts <- function(data){
    list(
        ...
        scale_colour_manual(values = idColors),
...
```{r plot-tcms-subset-region}

if(params$subset_tcms){
    tcms_tracks_plot_list <- 
        lapply(seq(1,n), function(i) {
            
            tcms_tracks_plot_list[[i]] <- tracks_plot_list[[i]] + 
...
image_write(image = plot_animated,
            path = str_c(dir, "stretch_2023_",params$timestep,"_animation_", params$enddate, "_", params$eov, ".gif"))
